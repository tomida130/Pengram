...
![Pengram_AWS_filan drawio](https://github.com/user-attachments/assets/2ab4f690-556b-48c0-be1e-5cbb311440fa)
...
- 検索機能に全文検索を用いている、これにより検索対象が増えた場合高速になる
...
- EC2が1つで分散さえていないので重い
- Laravel Breezeを日本語化
- 投稿数が多くなる場合現状のテーブルだといいね数を毎回カウントすると遅くなる、「いいね数」テーブルを作成し高速化する必要がある
## 変更
