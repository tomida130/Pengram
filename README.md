...
サイト内描画機能: ユーザーはサイト上で直接絵を描いて投稿する必要があります。これにより、AIで生成された画像の投稿を防ぎ、手描きの作品のみが共有されることを保証します。<br>
匿名投稿システム: 投稿者の名前を表示しないことで、作品の評価が純粋に絵の質に基づいて行われるようにしました。これにより、新人アーティストも既存の知名度に左右されることなく、公平に競争できる環境を提供します。<br>
共有機能: ユーザーは気に入った作品を簡単に拡散することができます。これにより、優れた作品がより多くの人の目に触れる機会が増え、アーティストの露出度を高めることができます。<br><br>
